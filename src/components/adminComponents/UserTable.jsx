                                ...
                                <div key={user._id} className="bg-gray-100 dark:bg-gray-700 hover:scale-110 relative shadow-md overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-150 ease-in-out transform hover:bg-[#F97316] hover:dark:bg-[#EA580C]">
                                    ...
                                    <div className="flex sm:flex-row flex-col items-center sm:justify-start justify-center gap-4">
                                        ...
                                        <div className="w-fit transition-all transform duration-500">
                                            <h1 className="text-gray-600 dark:text-gray-200 font-bold capitalize">{user?.firstName} {user?.lastName}</h1>
                                            <Link
                                                className="text-xs flex flex-wrap text-gray-500 dark:text-gray-200"
                                            >
                                                {user?.email}
                                            </Link>
                                            <p className='text-sm text-gray-500 dark:text-gray-200'>role: {user?.role}</p>
