                    ...
                    <form action="#" method="POST" className="mt-8" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="space-y-5">
                                ...
                                <div className='grid gap-5 sm:grid-cols-2'>
                                    <div className="mt-2">
                                        ...
                                        <div className='flex relative '>
                                            ...
                                            >
                                                {visiable ? <Eye className='text-orange-700' /> : <EyeOff className='text-orange-700' />}
                                            </button>
                                        </div>
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <div className='flex relative '>
                                            ...
                                            >
                                                {confirmVisiable ? <Eye className='text-orange-700' /> : <EyeOff className='text-orange-700' />}
                                            </button>
                                        </div>
                            ...
                            <p className="mt-2 text-right text-sm text-gray-600 pb-2">
                                ...
                                >
                                    <span className='hover:underline hover:text-orange-500'>Log in</span>
                                </Link>
                            </p>
                        </div>
                    </form>
