        ...
        <div>
            ...
            <div className="py-5 container">
                ...
                <Card className="mt-8 p-5 cursor-pointer hover:scale-105 transition-all ease-linear delay-100">
                    ...
                    <p className="mt-4 text-justify">
                        You have the right to access, correct, or delete the personal information we have about you. You can also opt-out of receiving marketing communications from us. If you have any questions or concerns about our privacy practices, please contact us at privacy@urbanest.com.
                    </p>
                </Card>
            </div>
        </div>
